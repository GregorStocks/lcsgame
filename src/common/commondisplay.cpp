...
void printlocation(long loc)
{
  if (location[loc]->siege.siege)
  {
    ...
    else
    {
      ...
      {
      case SIEGE_POLICE:
        mvaddstr(2, 1, "The police are raiding this location!");
        break;
      case SIEGE_CIA:
        mvaddstr(2, 1, "The CIA is raiding this location!");
        break;
      case SIEGE_HICKS:
        mvaddstr(2, 1, "The masses are storming this location!");
        break;
      case SIEGE_CORPORATE:
        mvaddstr(2, 1, "The Corporations are raiding this location!");
        break;
      case SIEGE_CCS:
        mvaddstr(2, 1, "The CCS is raiding this location!");
        break;
      case SIEGE_FIREMEN:
        mvaddstr(2, 1, "Firemen are raiding this location!");
        break;
      }
    }
  }
