...
std::string getview(short view, bool shortname) {
  if (shortname) switch (view) {
    ...
    case VIEW_GAY:
      return "LGBTQ Rights";
    case VIEW_DEATHPENALTY:
      return "Barbaric Executions";
    case VIEW_TAXES:
      return "The Tax Structure";
    case VIEW_NUCLEARPOWER:
      return "Nuclear Meltdowns";
    case VIEW_ANIMALRESEARCH:
      return "Animal Cruelty";
    case VIEW_POLICEBEHAVIOR:
    ...
    case VIEW_DRUGS:
      return "Oppressive Drug Laws";
    case VIEW_IMMIGRATION:
      return "Immigrant Rights";
    case VIEW_MILITARY:
      return "Military Spending";
    case VIEW_AMRADIO:
      return "AM Radio Propaganda";
    case VIEW_CABLENEWS:
      return "Cable \"News\" Lies";
...
std::string getlaw(int l) {
  ...
  case LAW_ANIMALRESEARCH:
    return "Animal Rights"; // a.k.a. "Animal Research"
  case LAW_POLICEBEHAVIOR:
    return "Police Regulation"; // a.k.a. "Police Behavior"
  case LAW_PRIVACY:
    return "Privacy Rights"; // a.k.a. "Privacy"
  case LAW_DEATHPENALTY:
    return "Death Penalty"; // a.k.a. "Capital Punishment"
  case LAW_NUCLEARPOWER:
    return "Nuclear Power";
  case LAW_POLLUTION:
    return "Pollution";
  case LAW_LABOR:
    return "Labor Laws"; // a.k.a. "Workers' Rights"
  case LAW_GAY:
    return "Gay Rights"; // a.k.a. "Homosexual Rights"
  case LAW_CORPORATE:
    return "Corporate Law"; // a.k.a. "Corporate Ethics"
  case LAW_FREESPEECH:
    return "Free Speech"; // a.k.a. "Freedom of Speech"
  case LAW_FLAGBURNING:
    return "Flag Burning";
  case LAW_GUNCONTROL:
    return "Gun Control";
  case LAW_TAX:
    return "Tax Structure"; // a.k.a. "Tax Law"
  case LAW_WOMEN:
    return "Women's Rights";
  case LAW_CIVILRIGHTS:
    return "Civil Rights";
  case LAW_DRUGS:
    return "Drug Laws"; // a.k.a. "Drug Law"
  case LAW_IMMIGRATION:
    return "Immigration";
  case LAW_ELECTIONS:
    return "Election Reform";
  case LAW_MILITARY:
    return "Military Spending";
  case LAW_PRISONS:
    return "Prison Regulation";
  case LAW_TORTURE:
    return "Human Rights";
  default:
...
std::string getlawflag(int type) {
  ...
  case LAWFLAG_BURNFLAG:
    return (law[LAW_FLAGBURNING] == -2 ? "Flag Murder" : "Flag burning");
  case LAWFLAG_SPEECH:
    return "Harmful speech";
  case LAWFLAG_BROWNIES:
    return "Drug dealing";
  case LAWFLAG_ESCAPED:
    return "Escaping prison";
  case LAWFLAG_HELPESCAPE:
    return "Releasing prisoners";
  case LAWFLAG_JURY:
    return "Jury tampering";
  ...
  case LAWFLAG_HIREILLEGAL:
    return (law[LAW_IMMIGRATION] < 1 ? "Hiring illegal aliens" : "Hiring undocumented workers");
  ...
  case LAWFLAG_COMMERCE:
    return "Electronic sabotage";
  case LAWFLAG_INFORMATION:
    return "Hacking";
  case LAWFLAG_BURIAL:
    return "Unlawful burial";
  ...
  case LAWFLAG_DISTURBANCE:
    return "Disturbing the peace";
  case LAWFLAG_PUBLICNUDITY:
    return "Public nudity";
...
std::string getalign(signed char alignment, bool capitalize) {
  ...
  case ALIGN_CONSERVATIVE:
    return "Conservative";
  case ALIGN_MODERATE:
    return (capitalize ? "Moderate" : "moderate");
  case ALIGN_LIBERAL:
    return "Liberal";
