...
void printnews(short li, short newspaper) {
  ...
  } else if (loottype[li]->get_idname() == "LOOT_INTHQDISK" || loottype[li]->get_idname() == "LOOT_SECRETDOCUMENTS") {
    move(6, 1);
  ...
  while (true) {
      ...
      if (ledger.expense[i]) {
        ...
        if (page == numpages - 1) {
          ...
          case EXPENSE_SKETCHES:
            mvaddstr(y, 0, "Drawing Materials");
            break;
          case EXPENSE_FOOD:
          ...
          case EXPENSE_MANUFACTURE:
            mvaddstr(y, 0, "Manufacturing");
            break;
          case EXPENSE_CARS:
            mvaddstr(y, 0, "New Cars");
            break;
          ...
          case EXPENSE_TSHIRTS:
            mvaddstr(y, 0, "T-Shirt Materials");
            break;
          default:
    ...
    if (numpages > 1) {
      ...
      while (true) {
        ...
        //PAGE UP
        if (c == interface_pgup || c == KEY_UP || c == KEY_LEFT) {
          page--;
