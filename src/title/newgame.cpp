  ...
  if (nightmarelaws) {
    ...
    for (int s = 0; s < SENATENUM; s++) {
      if (s < 55)
        ...
        senate[s] = ALIGN_CONSERVATIVE;
      else if (s < 80)
        senate[s] = ALIGN_MODERATE;
      else if (s < 97)
        senate[s] = ALIGN_LIBERAL;
      else
    ...
    for (int h = 0; h < HOUSENUM; h++) {
      if (h < 220)
        ...
        house[h] = ALIGN_CONSERVATIVE;
      else if (h < 400)
        house[h] = ALIGN_MODERATE;
      else if (h < 425)
        house[h] = ALIGN_LIBERAL;
      else
    ...
    for (int c = 0; c < COURTNUM; c++) {
      if (c < 5)
        ...
        court[c] = ALIGN_CONSERVATIVE;
      else if (c < 8)
        court[c] = ALIGN_MODERATE;
      else if (c < 8)
