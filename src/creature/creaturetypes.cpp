...
void makecreature(Creature &cr, short type) {
  ...
  case CREATURE_HICK:
    ...
    case 0:
      ...
      break;
    case 1:
      strcpy(cr.name, "Good ol' Boy");
      break;
    case 2:
      strcpy(cr.name, "Hick");
      break;
    case 3:
      strcpy(cr.name, "Hillbilly");
      break;
    case 4:
  ...
  case CREATURE_THIEF:
    switch (LCSrandom(5)) {
    case 0:
      strcpy(cr.name, getcreaturetype(CREATURE_SOCIALITE)->get_encounter_name());
      break;
    case 1:
      strcpy(cr.name, getcreaturetype(CREATURE_CLERK)->get_encounter_name());
      break;
    case 2:
      strcpy(cr.name, getcreaturetype(CREATURE_OFFICEWORKER)->get_encounter_name());
      break;
    case 3:
      strcpy(cr.name, getcreaturetype(CREATURE_CRITIC_ART)->get_encounter_name());
      break;
    case 4:
      strcpy(cr.name, getcreaturetype(CREATURE_CRITIC_MUSIC)->get_encounter_name());
      break;
    }
...
bool verifyworklocation(Creature &cr, char test_location, char test_type) {
  ...
  if (swap) {
    ...
    if (!len(goodlist))
      ...
      cr.worklocation = pickrandom(goodlist);
  }
  return false;
}
