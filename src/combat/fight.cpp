        ...
        if (encounter[e].animalgloss == ANIMALGLOSS_NONE) {
          if (!incapacitated(encounter[e], 0, printed)) {
            ...
            if ((encounter[e].wound[BODYPART_LEG_RIGHT] & WOUND_NASTYOFF) ||
              ...
              addstr(pickrandom(escape_running), gamelog);
    ...
    if (damamount > 0) {
      ...
      if ((target->wound[BODYPART_HEAD] & WOUND_CLEANOFF) ||
        ...
        if (w == BODYPART_HEAD && target->wound[BODYPART_HEAD] & WOUND_CLEANOFF)
          ...
          strcat(str, attack_used->hit_punctuation);
        move(17, 1);
        //set_color(COLOR_WHITE,COLOR_BLACK,1);
        if (goodguyattack)
          set_color(COLOR_GREEN, COLOR_BLACK, 1);
    ...
    if (melee && aroll < droll - 10 && t.blood > 70 && t.animalgloss == ANIMALGLOSS_NONE && t.is_armed() && t.get_weapon().get_attack(false, true, true) != NULL) {
      ...
      if (sneak_attack) {
        ...
        if (mode == GAMEMODE_CHASECAR) {
          ...
          case 2:
            strcpy(str, a.name);
            strcat(str, " just barely missed!");
            break;
          case 3:
            strcat(str, " can't seem to keep the vehicle in either the lane or the line of fire!");
            break;
          case 4:
            strcat(str, " swerves randomly!");
            break;
          case 5:
            strcat(str, " cuts off another driver and the shot is blocked!");
            break;
          case 6:
            strcat(str, " drops behind a hill in the road!");
            break;
          case 7:
            strcat(str, " changes lanes at the last second!");
            break;
          case 8:
            strcat(str, " accelerates suddenly and the shot goes short!");
            break;
          case 9:
            strcat(str, " fakes a left, and goes right instead!");
            break;
          case 10:
            strcat(str, " fakes a right, and goes left instead!");
            break;
          case 11:
            strcat(str, " fakes with the brakes while powering ahead!");
            break;
          case 12:
            strcat(str, " swerves to the other side of a truck!");
            break;
          case 13:
            strcat(str, " weaves through a row of taxis!");
            break;
          case 14:
            strcat(str, " dodges behind a hot dog cart!");
            break;
          case 15:
            strcat(str, " squeezes between some bridge supports for cover!");
            break;
          case 16:
            strcat(str, " squeals around a corner and behind a building!");
            break;
          case 17:
            strcat(str, " power slides through a narrow gap in the traffic!");
            break;
          case 18:
            strcat(str, " rolls the car onto two wheels to dodge the shot!");
            break;
          default:
            strcpy(str, a.name);
          ...
          case 2:
            ...
            break;
          case 3:
            strcat(str, " tumbles out of the way!");
            break;
          case 4:
            strcat(str, " jumps aside at the last moment!");
            break;
          case 5:
            strcat(str, " leaps for cover!");
            break;
          case 6:
            strcat(str, " ducks back behind cover!");
            break;
          case 7:
            strcat(str, " wisely stays behind cover!");
            break;
          case 8:
            strcat(str, " rolls away from the attack!");
            break;
          case 9:
            strcat(str, " nimbly dodges away from the line of fire!");
            break;
          case 10:
            strcat(str, " leaps over the attack!");
            break;
          case 11:
            strcat(str, " gracefully dives to avoid the attack!");
            break;
          case 12:
            strcat(str, " twists to avoid the attack!");
            break;
          case 13:
            strcat(str, " spins to the side!");
            break;
          case 14:
            strcat(str, " does the Matrix-dodge!");
            break; // You saying I can dodge bullets?
          case 15:
            strcat(str, " avoids the attack with no difficulty at all!");
            break;
          case 16:
            strcat(str, " flexes slightly to avoid being hit!");
            break;
          case 17:
            strcat(str, " confidently allows the attack to miss!");
            break;
          case 18:
            strcat(str, " seems to avoid the attack with only an angry glare!");
            break; //When you're ready, you won't have to.
          default:
            strcpy(str, a.name);
            strcat(str, " misses completely!");
            break; // You failed to hit someone who probably rolled a zero.  You should feel bad.
...
void damagemod(Creature &t, char &damtype, int &damamount,
  ...
  if (mod <= -20)
    damamount >>= 8; //Cars plus heavy armor can be really tough.
  else if (mod <= -14)
    damamount >>= 7;
  else if (mod <= -8)
    damamount >>= 6;
  ...
  if (a.blood <= 20 || (a.blood <= 50 && (LCSrandom(2) || a.forceinc))) {
    ...
    if (noncombat) {
      ...
      case 22:
        ...
        break;
      case 23:
        if (a.special[SPECIALWOUND_RIGHTEYE] && a.special[SPECIALWOUND_LEFTEYE])
