...
void displaysinglead(bool liberalguardian, char addplace[2][3], short *storyx_s, short *storyx_e, int &it2)
{
  ...
  for (int x2 = 0; x2 < 2; x2++)
    for (int y2 = 0; y2 < 3; y2++)                                                // loop thru ad places to see ads already up
  ...
  //AD CONTENT
  {
    ...
    for (it2 = 0; it2 < 25; it2++)
      storyx_s[it2] = 40, storyx_e[it2] = 40;
    ...
    {                 // Liberal Guardian Ads
      ...
      case 6:
      {
        ...
        case 0:
          ...
          break;
        case 1:
          strcat(ad, "Seeking Sex");
          break;
        case 2:
          strcat(ad, "Wanna Have Sex?");
          break;
        case 3:
          strcat(ad, "Looking For Sex");
          break;
        case 4:
          strcat(ad, "Sex Partner Wanted");
          break;
        }
        char str[10];
        strcat(ad, "&r&r");
