  ...
  if (positive) {
    ...
    case VIEW_AMRADIO: {
      ...
      case 3:
        ...
        if (presparty != CONSERVATIVE_PARTY)
    ...
    case VIEW_INTELLIGENCE: {
      ...
      case 1:
        if (law[LAW_FREESPEECH] == -2)
          strcat(story, "[put] fertilizer [on plants] at a federal building");
        else
          strcat(story, "detonate a fertilizer bomb at a federal building");
        break;
      case 2:
        if (law[LAW_FREESPEECH] == -2)
          strcat(story, "[show up uninvited on] a warship");
        else
          strcat(story, "ram a motorboat loaded with explosives into a warship");
        break;
      case 3:
        if (law[LAW_FREESPEECH] == -2)
          strcat(story, "[give children owies and boo-boos]");
        else
          strcat(story, "detonate explosives on a school bus");
        break;
      case 4:
        if (law[LAW_FREESPEECH] == -2)
          strcat(story, "[cause a traffic jam on] a major bridge");
        else
      ...
      case 7:
        if (law[LAW_FREESPEECH] == -2)
          strcat(story, "[vandalize] the Capitol Building");
        else
          strcat(story, "destroy the Capitol Building");
        break;
      case 8:
        if (law[LAW_FREESPEECH] == -2)
          strcat(story, "detonate [fireworks] in New York");
        else
    ...
    case VIEW_JUSTICES: {
      ...
      switch (LCSrandom(7)) {
      case 0:
        strcat(story, "ten-year-old eyewitness testimony");
        break;
      case 1:
        strcat(story, gen);
      ...
      case 6:
        strcat(story, gen);
        strcat(story, " consultations with a Magic 8-Ball");
        break;
      }
    ...
    case VIEW_POLLUTION:
      ...
      case 4:
        ...
        break;
      case 5:
        strcat(story, "drinking a cup of fracking fluid a day");
        break;
      }
      ...
      case 4:
        ...
        break;
      case 5:
        strcat(story, "cure everything from abdominal ailments to zygomycosis");
        break;
      }
      strcat(story, ".");
      strcat(story, "&r");
      ...
      case 2:
        ...
        break;
      case 3:
        strcat(story, "I just tried it myself and I feel like a million bucks!  *Coughs up blood*  I'm OK, that's just ketchup");
        break;
      }
      ...
      case 2:
        ...
        break;
      case 3:
        strcat(story, "leftists suffering from the mental disorder chemophobia often distort");
        break;
      }
    ...
    case VIEW_CORPORATECULTURE:
      ...
      break;
    case VIEW_AMRADIO: { //THIS ONE IS SHORTER BECAUSE OF DOUBLE HEADLINE
      strcpy(story, cityname());
      ...
      case 2:
        if (law[LAW_FREESPEECH] == 2)
          ...
          strcat(story, "screamed \"f*ck the police those g*dd*mn m*th*f*ck*rs.  I got a f*cking ticket this morning and I'm f*cking p*ss*d as sh*t.\"");
        break;
      case 3:
    ...
    case VIEW_PRISONS: {
      ...
      case 3:
        if (law[LAW_FREESPEECH] == 2)
          strcat(story, "Imma kill all you bitches, startin' with this mothafucker here.");
        else if (law[LAW_FREESPEECH] == -2)
          strcat(story, "[I will harm all police officers], startin' with this [one] here.");
        else
          strcat(story, "Imma kill all you b*tches, startin' with this m*th*f*ck*r here.");
        break;
      }
      strcat(story, "\"");
      ...
      if (law[LAW_FREESPEECH] == -2)
        ...
        case 2:
          ...
          break;
        case 3:
          strcat(story, "smashed the guard's skull with the toilet seat from ");
          strcat(story, (dgn == GENDER_FEMALE ? "her" : "his"));
          strcat(story, " cell");
          break;
        case 4:
          strcat(story, "shot the guard with ");
          strcat(story, (ggn == GENDER_FEMALE ? "her" : "his"));
          strcat(story, " own gun");
          break;
        case 5:
          strcat(story, "poisoned the guard with drugs smuggled into the prison by the ");
          strcat(story, (LCSrandom(2) ? "Crips" : "Bloods"));
          break;
        case 6:
          strcat(story, "hit all 36 pressure points of death on the guard");
          break;
        case 7:
          strcat(story, "electrocuted the guard with high-voltage wires");
          break;
        case 8:
          strcat(story, "thrown the guard out the top-storey window");
          break;
        case 9:
          strcat(story, "taken the guard to the execution chamber and finished ");
          strcat(story, (ggn == GENDER_FEMALE ? "her" : "him"));
          strcat(story, " off");
          break;
        case 10:
          strcat(story, "tricked another guard into shooting the guard dead");
          break;
        case 11:
          strcat(story, "burnt the guard to a crisp using a lighter and some gasoline");
          break;
        case 12:
          strcat(story, "eaten the guard's liver with some fava beans and a nice chianti");
          break;
        case 13:
          strcat(story, "performed deadly experiments on the guard unheard of since Dr. Mengele");
          break;
        case 14:
          strcat(story, "sacrificed the guard on a makeshift ");
