    ...
    if (activesquad->squad[p]->skill_check(SKILL_SECURITY, difficulty))
    {
      ...
      if (maxattack <= difficulty)
      {
        ...
        case FIELDSKILLRATE_HARD:
          activesquad->squad[p]->train(SKILL_SECURITY, 0);
          break;
        }
      }
            ...
            activesquad->squad[j]->get_skill(SKILL_SECURITY) < difficulty)
        {
          if (activesquad->squad[j]->alive)
          {
            ...
            case FIELDSKILLRATE_CLASSIC:
              ...
              break;
            case FIELDSKILLRATE_HARD:
              activesquad->squad[j]->train(SKILL_SECURITY, 0);
              break;
            }
          }
        }
  ...
  if (hacker > -1)
  {
    ...
    if (maxattack > difficulty)
    {
      ...
      case HACK_SUPERCOMPUTER:
        ...
        break;
      case HACK_VAULT:
        addstr(" disabled the second layer of security", gamelog);
        break;
      }
      if (blind)
    ...
    else
    {
      ...
      case HACK_SUPERCOMPUTER:
        ...
        break;
      case HACK_VAULT:
        addstr(" bypass the vault's electronic lock.", gamelog);
        break;
      }
      gamelog.newline();
