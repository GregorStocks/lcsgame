...
char doYouComeHereOften(Creature &a, Creature &tk) {
  ...
  if (law[LAW_FREESPEECH] == -2) {
    ...
    case 43:
      ...
      break;
    case 44:
      addstr("\"Roses are red, violets are blue,", gamelog);
      move(11, 1);
      y++;
      addstr("All my base, are belong to you.\"", gamelog);
      break;
    case 45:
      addstr("\"Did it hurt when you fell from heaven?\"", gamelog);
      break;
    case 46:
      addstr("\"Holy shit you're hot!  I want to have sex with you RIGHT NOW.\"", gamelog);
      break;
    }
  }
  gamelog.newline();
  ...
  if ((a.get_armor().get_itemtypename() == "ARMOR_POLICEUNIFORM" // Police property on armor? -XML
    ...
    if (law[LAW_FREESPEECH] == -2) {
      ...
      case 43:
        ...
        break;
      case 44:
        addstr("\"It's you!!  Somebody set up us the bomb.  Move 'Zig'.  For great justice.\"", gamelog);
        break;
      case 45:
        addstr("\"Actually I'm a succubus from hell, and you're my next victim.\"", gamelog);
        break;
      case 46:
        addstr("\"Can you wait a couple hours?  I got 6 other people to fuck first.\"", gamelog);
        break;
      }
    }
    gamelog.newline();
    ...
    *newcr = tk;
    ...
    if (tk.type == CREATURE_CORPORATE_CEO) {
      ...
      case 0:
        ...
        break;
      case 1:
        addstr("\"No.  I am your father.\"", gamelog);
        break;
      case 2:
      ...
      case 0:
        ...
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <pouts>", gamelog);
        break;
      case 1:
        addstr("\"Sure, here ya go...\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <writes wrong number>", gamelog);
        break;
      case 2:
        ...
        break;
      case 3:
        addstr("\"Go use a real bathroom, ya hick.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <points towards bathroom>", gamelog);
        break;
      case 4:
        addstr("\"That was a very traumatic incident.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <cries>", gamelog);
        break;
      case 5:
        addstr("\"You're big everywhere, fatass.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <laughs>", gamelog);
        break;
      case 6:
        ...
        break;
      case 7:
        addstr("\"You fuck squirrels?\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <looks dumbfounded>", gamelog);
        break;
      case 8:
        addstr("\"So what you're saying is you masturbate a lot.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <wags finger>", gamelog);
        break;
      case 9:
        ...
        break;
      case 10:
        addstr("\"Nice try, but no.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <sticks out tongue>", gamelog);
        break;
      case 11:
        ...
        break;
      case 12:
        addstr("\"You look like a biter.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <flinches>", gamelog);
        break;
      case 13:
        addstr("\"I'm way outta your league, scumbag.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <grabs pepper spray>", gamelog);
        break;
      case 14:
        addstr("\"You still watch cartoons?\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <laughs>", gamelog);
        break;
      case 15:
        addstr("\"I hate puns!  You suck at comedy.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <frowns>", gamelog);
        break;
      case 16:
        addstr("\"Yes, I'm an alien, you inferior Earth scum.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <reaches for ray gun>", gamelog);
        break;
      case 17:
        addstr("\"Not after I do this.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <shits pants>", gamelog);
        break;
      case 18:
        addstr("\"Yes, I can't stand liars.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <crosses flabby arms>", gamelog);
        break;
      case 19:
        addstr("\"I don't remember doing that.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <looks confused>", gamelog);
        break;
      case 20:
        addstr("\"We got a kindergarten dropout over here!\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <points and laughs>", gamelog);
        break;
      case 21:
        addstr("\"No, I don't want to infect anyone else with herpes.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <sighs>", gamelog);
        break;
      case 22:
        addstr("\"Stop staring at my feet, you freak!\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <kicks you>", gamelog);
        break;
      case 23:
        addstr("\"You're such a loser.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <makes L sign on forehead>", gamelog);
        break;
      case 24:
        addstr("\"I'm about to put a voodoo curse on yo ass...\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <starts chanting>", gamelog);
        break;
      case 25:
        addstr("\"I don't approve of your hi-carb diet.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <starts ranting about nutrition>", gamelog);
        break;
      case 26:
        addstr("\"Go back home to play with your G.I. Joe dolls.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <scoffs>", gamelog);
        break;
      case 27:
        addstr("\"No, and stop acting like a lost puppy.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <hisses like a cat>", gamelog);
        break;
      case 28:
        addstr("\"Jesus...\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        ...
        break;
      case 29:
        addstr("\"I don't believe in astrology, you ignoramus.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <blinds you with science>", gamelog);
        break;
      case 30:
        addstr("\"Yes, and it's practically microscopic.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <puts 2 fingers really close together>", gamelog);
        break;
      case 31:
        addstr("\"My spouse will be here soon to straighten things out.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <looks for spouse>", gamelog);
        break;
      case 32:
        ...
        break;
      case 33:
        addstr("\"Yes, here you go...\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <writes fake directions>", gamelog);
        break;
      case 34:
        addstr("\"Gotta go!  Bye!\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <squirms away>", gamelog);
        break;
      case 35:
        addstr("\"I don't do anal.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <puts hands over butt>", gamelog);
        break;
      case 36:
        ...
        break;
      case 37:
        addstr("\"Go home, you're drunk.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <gestures away>", gamelog);
        break;
      case 38:
        addstr("\"At least then you'd be liquidated.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <stares intently>", gamelog);
        break;
      case 39:
        addstr("\"Laaaame.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <looks bored>", gamelog);
        break;
      case 40:
        addstr("\"Eew, no, gross.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <vomits on you>", gamelog);
        break;
      case 41:
        addstr("\"Too late for apologies!\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <slaps you>", gamelog);
        break;
      case 42:
        addstr("\"What an idiot!\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <laughs>", gamelog);
        break;
      case 43:
        addstr("\"Nothing works, I can't help it.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <starts crying>", gamelog);
        break;
      case 44:
        ...
        break;
      case 45:
        addstr("\"Yes, now go away.\"", gamelog);
        set_color(COLOR_WHITE, COLOR_BLACK, 1);
        addstr(" <points to exit>", gamelog);
        break;
      case 46:
  ...
  if (you_are_stupid) {
    ...
    case LAW_POLLUTION:
      ...
      if (tk.animalgloss == ANIMALGLOSS_ANIMAL)
        addstr("the environment in ways that hurt not only humans, but animals too.", gamelog);
      else
